...
extension JSRuntime {
    /// init.js（Venera JS Library）源码，构建时以常量内嵌，避免
    /// SPM 资源 bundle 在 xcodebuild -target 模式下的定位问题。
    /// 内容与 Flutter 版 assets/init.js 完全一致（版本对齐 v2.2.11）。
    static let initJsEmbedded: String = #"""
/*
